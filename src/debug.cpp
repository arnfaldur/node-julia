...
string nj::getTypeName(jl_value_t *v)
{
   ...
   if(v)
   {
     ...
     if(jl_is_method(v)) ss << "value is method";
     if(jl_is_string(v)) ss << "value is string";
     if(jl_is_uniontype(v)) ss << "value is union";
     if(jl_is_unionall(v)) ss << "value is unionall";
     if(jl_is_symbol(v)) ss << "value is symbol";
     if(jl_is_code_info(v)) ss << "value is code_info";
     if(jl_is_vararg_type(v)) ss << "value is vararg_type";
